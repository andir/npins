...
SUBCOMMANDS:
    ...
    git-hub-actions-update    Run the GitHub Action update. This produces a commit message and a PR message file
    ...
    upgrade                   Upgrade the sources.json and default.nix to the latest format version. This may
                              occasionally break Nix evaluation!
```

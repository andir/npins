...
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -l name -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -r -f
...
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -s h -l help -d 'Print help'
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -l name -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -r -f

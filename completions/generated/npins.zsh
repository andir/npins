...
'::artifact -- Select a specific artifact from the channel, defaults to Nixpkgs if omitted:_default' \
&& ret=0
;;
(github)
_arguments "${_arguments_options[@]}" : \
...
_arguments "${_arguments_options[@]}" : \
'--name=[Add the pin with a custom name. If a pin with that name already exists, it will be overwritten]:NAME:' \
'--mutable[Treat this URL as mutable, and assume it will redirect to an immutable version of the content to be pinned. For example, a HEAD URL redirecting to the currently latest commit]' \
'--frozen[Add the pin as frozen, meaning that it will be ignored by \`npins update\` by default]' \
'-v[Print debug messages]' \
'--verbose[Print debug messages]' \
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
':url -- Tarball URL:_default' \
&& ret=0
;;
(url)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
':url -- URL to pin:_default' \
&& ret=0
;;
(help)
_arguments "${_arguments_options[@]}" : \
":: :_npins__subcmd__add__subcmd__help_commands" \
"*::: :->help" \
&& ret=0
...
(add)
_arguments "${_arguments_options[@]}" : \
":: :_npins__subcmd__help__subcmd__add_commands" \
"*::: :->add" \
&& ret=0
...
(( $+functions[_npins__subcmd__add_commands] )) ||
_npins__subcmd__add_commands() {
    local commands; commands=(
...
(( $+functions[_npins__subcmd__add__subcmd__channel_commands] )) ||
_npins__subcmd__add__subcmd__channel_commands() {
    local commands; commands=()
    _describe -t commands 'npins add channel commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__container_commands] )) ||
_npins__subcmd__add__subcmd__container_commands() {
    local commands; commands=()
    _describe -t commands 'npins add container commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__forgejo_commands] )) ||
_npins__subcmd__add__subcmd__forgejo_commands() {
    local commands; commands=()
    _describe -t commands 'npins add forgejo commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__git_commands] )) ||
_npins__subcmd__add__subcmd__git_commands() {
    local commands; commands=()
    _describe -t commands 'npins add git commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__github_commands] )) ||
_npins__subcmd__add__subcmd__github_commands() {
    local commands; commands=()
    _describe -t commands 'npins add github commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__gitlab_commands] )) ||
_npins__subcmd__add__subcmd__gitlab_commands() {
    local commands; commands=()
    _describe -t commands 'npins add gitlab commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help_commands] )) ||
_npins__subcmd__add__subcmd__help_commands() {
    local commands; commands=(
'channel:Track a Nix channel' \
'github:Track a GitHub repository' \
...
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__channel_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__channel_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help channel commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__container_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__container_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help container commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__forgejo_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__forgejo_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help forgejo commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__git_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__git_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help git commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__github_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__github_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help github commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__gitlab_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__gitlab_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help gitlab commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__help_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__help_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help help commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__pypi_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__pypi_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help pypi commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__tarball_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__tarball_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help tarball commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__help__subcmd__url_commands] )) ||
_npins__subcmd__add__subcmd__help__subcmd__url_commands() {
    local commands; commands=()
    _describe -t commands 'npins add help url commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__pypi_commands] )) ||
_npins__subcmd__add__subcmd__pypi_commands() {
    local commands; commands=()
    _describe -t commands 'npins add pypi commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__tarball_commands] )) ||
_npins__subcmd__add__subcmd__tarball_commands() {
    local commands; commands=()
    _describe -t commands 'npins add tarball commands' commands "$@"
}
(( $+functions[_npins__subcmd__add__subcmd__url_commands] )) ||
_npins__subcmd__add__subcmd__url_commands() {
    local commands; commands=()
    _describe -t commands 'npins add url commands' commands "$@"
}
(( $+functions[_npins__subcmd__freeze_commands] )) ||
_npins__subcmd__freeze_commands() {
    local commands; commands=()
    _describe -t commands 'npins freeze commands' commands "$@"
}
(( $+functions[_npins__subcmd__get-path_commands] )) ||
_npins__subcmd__get-path_commands() {
    local commands; commands=()
    _describe -t commands 'npins get-path commands' commands "$@"
}
(( $+functions[_npins__subcmd__help_commands] )) ||
_npins__subcmd__help_commands() {
    local commands; commands=(
'init:Initializes the npins directory. Running this multiple times will restore/upgrade the \`default.nix\` and never touch your sources.json' \
'add:Adds a new pin entry' \
...
(( $+functions[_npins__subcmd__help__subcmd__add_commands] )) ||
_npins__subcmd__help__subcmd__add_commands() {
    local commands; commands=(
'channel:Track a Nix channel' \
'github:Track a GitHub repository' \
...
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__channel_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__channel_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add channel commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__container_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__container_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add container commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__forgejo_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__forgejo_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add forgejo commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__git_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__git_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add git commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__github_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__github_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add github commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__gitlab_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__gitlab_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add gitlab commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__pypi_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__pypi_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add pypi commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__tarball_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__tarball_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add tarball commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__add__subcmd__url_commands] )) ||
_npins__subcmd__help__subcmd__add__subcmd__url_commands() {
    local commands; commands=()
    _describe -t commands 'npins help add url commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__freeze_commands] )) ||
_npins__subcmd__help__subcmd__freeze_commands() {
    local commands; commands=()
    _describe -t commands 'npins help freeze commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__get-path_commands] )) ||
_npins__subcmd__help__subcmd__get-path_commands() {
    local commands; commands=()
    _describe -t commands 'npins help get-path commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__help_commands] )) ||
_npins__subcmd__help__subcmd__help_commands() {
    local commands; commands=()
    _describe -t commands 'npins help help commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__import-flake_commands] )) ||
_npins__subcmd__help__subcmd__import-flake_commands() {
    local commands; commands=()
    _describe -t commands 'npins help import-flake commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__import-niv_commands] )) ||
_npins__subcmd__help__subcmd__import-niv_commands() {
    local commands; commands=()
    _describe -t commands 'npins help import-niv commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__init_commands] )) ||
_npins__subcmd__help__subcmd__init_commands() {
    local commands; commands=()
    _describe -t commands 'npins help init commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__remove_commands] )) ||
_npins__subcmd__help__subcmd__remove_commands() {
    local commands; commands=()
    _describe -t commands 'npins help remove commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__show_commands] )) ||
_npins__subcmd__help__subcmd__show_commands() {
    local commands; commands=()
    _describe -t commands 'npins help show commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__unfreeze_commands] )) ||
_npins__subcmd__help__subcmd__unfreeze_commands() {
    local commands; commands=()
    _describe -t commands 'npins help unfreeze commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__update_commands] )) ||
_npins__subcmd__help__subcmd__update_commands() {
    local commands; commands=()
    _describe -t commands 'npins help update commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__upgrade_commands] )) ||
_npins__subcmd__help__subcmd__upgrade_commands() {
    local commands; commands=()
    _describe -t commands 'npins help upgrade commands' commands "$@"
}
(( $+functions[_npins__subcmd__help__subcmd__verify_commands] )) ||
_npins__subcmd__help__subcmd__verify_commands() {
    local commands; commands=()
    _describe -t commands 'npins help verify commands' commands "$@"
}
(( $+functions[_npins__subcmd__import-flake_commands] )) ||
_npins__subcmd__import-flake_commands() {
    local commands; commands=()
    _describe -t commands 'npins import-flake commands' commands "$@"
}
(( $+functions[_npins__subcmd__import-niv_commands] )) ||
_npins__subcmd__import-niv_commands() {
    local commands; commands=()
    _describe -t commands 'npins import-niv commands' commands "$@"
}
(( $+functions[_npins__subcmd__init_commands] )) ||
_npins__subcmd__init_commands() {
    local commands; commands=()
    _describe -t commands 'npins init commands' commands "$@"
}
(( $+functions[_npins__subcmd__remove_commands] )) ||
_npins__subcmd__remove_commands() {
    local commands; commands=()
    _describe -t commands 'npins remove commands' commands "$@"
}
(( $+functions[_npins__subcmd__show_commands] )) ||
_npins__subcmd__show_commands() {
    local commands; commands=()
    _describe -t commands 'npins show commands' commands "$@"
}
(( $+functions[_npins__subcmd__unfreeze_commands] )) ||
_npins__subcmd__unfreeze_commands() {
    local commands; commands=()
    _describe -t commands 'npins unfreeze commands' commands "$@"
}
(( $+functions[_npins__subcmd__update_commands] )) ||
_npins__subcmd__update_commands() {
    local commands; commands=()
    _describe -t commands 'npins update commands' commands "$@"
}
(( $+functions[_npins__subcmd__upgrade_commands] )) ||
_npins__subcmd__upgrade_commands() {
    local commands; commands=()
    _describe -t commands 'npins upgrade commands' commands "$@"
}
(( $+functions[_npins__subcmd__verify_commands] )) ||
_npins__subcmd__verify_commands() {
    local commands; commands=()

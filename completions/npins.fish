...
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball help" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x

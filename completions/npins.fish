...
complete -c npins -n "__fish_npins_needs_command" -s d -l directory -d 'Base folder for sources.json and the boilerplate default.nix' -x -a "(__fish_complete_directories)"
complete -c npins -n "__fish_npins_needs_command" -l lock-file -d 'Specifies the path to the sources.json and activates lockfile mode. In lockfile mode, no default.nix will be generated and --directory will be ignored' -x
...
complete -c npins -n "__fish_npins_needs_command" -f -a "init" -d 'Initializes the npins directory. Running this multiple times will restore/upgrade the `default.nix` and never touch your sources.json'
...
complete -c npins -n "__fish_npins_needs_command" -f -a "freeze" -d 'Freezes a pin entry, preventing it from being changed during an update'
complete -c npins -n "__fish_npins_needs_command" -f -a "unfreeze" -d 'Thaws a pin entry, allowing it to be changed during an update like a normal pin'
...
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -l frozen -d 'Add the pin as frozen, meaning that it will be ignored by `npins update` by default'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -s n -l dry-run -d 'Don\'t actually apply the changes'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -s v -l verbose -d 'Print debug messages'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "channel" -d 'Track a Nix channel'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "github" -d 'Track a GitHub repository'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "forgejo" -d 'Track a Forgejo repository'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "gitlab" -d 'Track a GitLab repository'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "git" -d 'Track a git repository'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "pypi" -d 'Track a package on PyPi'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "container" -d 'Track an OCI container'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "tarball" -d 'Track a tarball'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "url" -d 'Track a URL'
complete -c npins -n "__fish_npins_using_subcommand add; and not __fish_seen_subcommand_from channel github forgejo gitlab git pypi container tarball url help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from channel" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from channel" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from github" -s b -l branch -d 'Track a branch instead of a release' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from github" -l at -d 'Use a specific commit/release instead of the latest. This may be a tag name, or a git revision when --branch is set' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from github" -l upper-bound -d 'Bound the version resolution. For example, setting this to "2" will restrict updates to 1.X versions. Conflicts with the --branch option' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from github" -l release-prefix -d 'Optional prefix required for each release name / tag. For example, setting this to "release/" will only consider those that start with that string' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from github" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -s b -l branch -d 'Track a branch instead of a release' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -l at -d 'Use a specific commit/release instead of the latest. This may be a tag name, or a git revision when --branch is set' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -l upper-bound -d 'Bound the version resolution. For example, setting this to "2" will restrict updates to 1.X versions. Conflicts with the --branch option' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -l release-prefix -d 'Optional prefix required for each release name / tag. For example, setting this to "release/" will only consider those that start with that string' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -l name -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from forgejo" -l pre-releases -a '(__fish_npins_pin_single)' -d 'Also track pre-releases. Conflicts with the --branch option'
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l server -d 'Use a self-hosted GitLab instance instead' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l private-token -d 'Use a private token to access the repository.' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -s b -l branch -d 'Track a branch instead of a release' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l at -d 'Use a specific commit/release instead of the latest. This may be a tag name, or a git revision when --branch is set' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l upper-bound -d 'Bound the version resolution. For example, setting this to "2" will restrict updates to 1.X versions. Conflicts with the --branch option' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l release-prefix -d 'Optional prefix required for each release name / tag. For example, setting this to "release/" will only consider those that start with that string' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from gitlab" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -l forge -x -a "none\t'A generic git pin, with no further information'
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -s b -l branch -d 'Track a branch instead of a release' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -l at -d 'Use a specific commit/release instead of the latest. This may be a tag name, or a git revision when --branch is set' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -l upper-bound -d 'Bound the version resolution. For example, setting this to "2" will restrict updates to 1.X versions. Conflicts with the --branch option' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -l release-prefix -d 'Optional prefix required for each release name / tag. For example, setting this to "release/" will only consider those that start with that string' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from git" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from pypi" -l at -d 'Use a specific release instead of the latest' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from pypi" -l upper-bound -d 'Bound the version resolution. For example, setting this to "2" will restrict updates to 1.X versions. Conflicts with the --branch option' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from pypi" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from container" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from tarball" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from tarball" -l mutable -d 'Treat this URL as mutable, and assume it will redirect to an immutable version of the content to be pinned. For example, a HEAD URL redirecting to the currently latest commit'
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -l name -a '(__fish_npins_pin_single)' -d 'Add the pin with a custom name. If a pin with that name already exists, it will be overwritten' -x
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -l mutable -d 'Treat this URL as mutable, and assume it will redirect to an immutable version of the content to be pinned. For example, a HEAD URL redirecting to the currently latest commit'
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -l frozen -d 'Add the pin as frozen, meaning that it will be ignored by `npins update` by default'
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -s v -l verbose -d 'Print debug messages'
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from url" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c npins -n "__fish_npins_using_subcommand add; and __fish_seen_subcommand_from help" -f -a "url" -d 'Track a URL'
...
complete -c npins -n "__fish_npins_using_subcommand show" -x -a '(__fish_npins_pin_list)'
...
complete -c npins -n "__fish_npins_using_subcommand update" -l max-concurrent-downloads -d 'Maximum number of simultaneous downloads' -x
...
complete -c npins -n "__fish_npins_using_subcommand verify" -l max-concurrent-downloads -d 'Maximum number of simultaneous downloads' -x
...
complete -c npins -n "__fish_npins_using_subcommand import-niv" -s n -l name -d 'Only import one entry from Niv' -x
...
complete -c npins -n "__fish_npins_using_subcommand import-flake" -s n -l name -d 'Only import one entry from the flake' -x
...
complete -c npins -n "__fish_npins_using_subcommand help; and not __fish_seen_subcommand_from init add show update verify upgrade remove import-niv import-flake freeze unfreeze get-path help" -f -a "init" -d 'Initializes the npins directory. Running this multiple times will restore/upgrade the `default.nix` and never touch your sources.json'
...
complete -c npins -n "__fish_npins_using_subcommand help; and not __fish_seen_subcommand_from init add show update verify upgrade remove import-niv import-flake freeze unfreeze get-path help" -f -a "freeze" -d 'Freezes a pin entry, preventing it from being changed during an update'
complete -c npins -n "__fish_npins_using_subcommand help; and not __fish_seen_subcommand_from init add show update verify upgrade remove import-niv import-flake freeze unfreeze get-path help" -f -a "unfreeze" -d 'Thaws a pin entry, allowing it to be changed during an update like a normal pin'
...
complete -c npins -n "__fish_npins_using_subcommand help; and __fish_seen_subcommand_from add" -f -a "url" -d 'Track a URL'
